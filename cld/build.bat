...
if %errorlevel%==0 cl -Od -Z7 -nologo -Wall -WX -wd4820 -wd4710 -wd4514 -EHsc- ph2_cld_test_cpp.cpp -o ph2_cld_test.exe
if %errorlevel%==0 cl -Od -Z7 -nologo -Wall -WX -wd4820 -wd4710 -wd4514 -EHsc- ph2_cld.c ph2_cld_test.c -o ph2_cld_test.exe
