...
cl -Od -Z7 -nologo -Wall -WX -wd4820 -wd4710 -wd4514 -wd4514 -EHsc- ph2_cld_test_cpp.cpp -c -Foph2_cld_test_cpp.obj || exit /b 1
cl -Od -Z7 -nologo -Wall -WX -wd4820 -wd4710 -wd4711 -wd4514 -EHsc- ph2_cld.c ph2_cld_test.c -Feph2_cld_test.exe || exit /b 1
